...
import com.mixno35.appmanager.adapter.fragment.DetailsAdapter;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (tabLayout != null) {
            ...
            if (!prefs.getBoolean(Data.PREFS_KEY_TAP_TARGET_DETAILS, false)) new TapTargetSequence(this).targets(
                            TapTarget.forView(Objects.requireNonNull(tabLayout.getTabAt(0)).view, getString(R.string.tab_basic), getString(R.string.message_tab_basic))
                                    .transparentTarget(true)
                                    .targetRadius(60)
                                    .cancelable(false)
                                    .dimColor(com.google.android.material.R.color.background_floating_material_dark),
                            TapTarget.forView(Objects.requireNonNull(tabLayout.getTabAt(1)).view, getString(R.string.tab_details), getString(R.string.message_tab_details))
                                    .transparentTarget(true)
                                    .targetRadius(60)
                                    .cancelable(false)
                                    .dimColor(com.google.android.material.R.color.background_floating_material_dark)
                    ...
                    .listener(new TapTargetSequence.Listener() {
                        ...
                        public void onSequenceFinish() {
                            prefs.edit().putBoolean(Data.PREFS_KEY_TAP_TARGET_DETAILS, true).apply();
                        }
